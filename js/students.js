...
// 註：課表對帳（掃行事曆備註 vs 修課登記簿）於 2026-07-29 第 4 刀移除——
// 唯一輸入是行事曆備註的名字，系統改自有課表後名冊由登記簿正向建立，無可對之帳。
...
// 註：舊「新增課程」行內面板（openAddCourse/submitAddCourse，直接寫 Google Calendar）
// 於 2026-07-29 第 4 刀移除——2026-07-04 起已由「新增課程/學生」獨立頁取代，HTML 早已 hidden。
